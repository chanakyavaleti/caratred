...
middle_customers.insertAdjacentHTML("beforeend",data);
  ...
  const button1=document.querySelector("#buttondata");


// ---------------------------popup-------------------- 
  button1.addEventListener("click",()=>{
    //  button1.innerHTML.toggle(<h3>hide all 20 amenities</h3>);

    for (let i = 0; i < display.length; i++) {
     display[i].classList.toggle("hidedata-off");
   }

  //  changing button text 
    if(button1.innerHTML === "Show all 20 amenities"){
      button1.innerHTML="hide all 20 amenities";
    }
    else{
      button1.innerHTML="Show all 20 amenities";
    }
